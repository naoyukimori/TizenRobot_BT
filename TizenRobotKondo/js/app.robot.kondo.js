...
function RobotKondoClient(adapter, serviceUUID) {
	'use strict';
...
(function () { // strict mode wrapper
	...
	RobotKondoClient.prototype = {
		...
		init: function Client_init() {
			this.model = new RobotKondoModel(this);
			return this;
		},
		...
		connectToServiceSuccess: function Client_connectToServiceSuccess(device, socket) {
			...
			socket.onmessage = function () {
				...
				console.log("app.robot.kondo.connectToServiceSuccess(): data comming.")
				...
				*/
				app.ui.displayReceivedMessage("Name", recvmsg, false, false);
			};
			...
			console.log("app.robot.kondo.connectToServiceSuccess(): will send ping...");
			this.sendPing();
		},
		...
		sendPing: function Client_sendPing() {
			console.log("app.robot.kondo.sendPing(): will send ping...");
